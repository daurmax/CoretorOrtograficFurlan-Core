...
namespace CoretorOrtografic.Infrastructure.KeyValueDatabase
{
    /// <summary>
    ...
    public class SQLiteKeyValueDatabase : IKeyValueDatabase
    {
        ...
        /// </summary>
        /// <param name="phoneticHash">The phonetic hash key calculated using FurlanPhoneticAlgorithm.GetPhoneticHashesByWord() method in the CoretorOrtografic.Core.FurlanPhoneticAlgorithm namespace.</param>
