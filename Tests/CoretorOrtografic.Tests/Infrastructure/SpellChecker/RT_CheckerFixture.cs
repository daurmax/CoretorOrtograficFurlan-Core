...
namespace CoretorOrtografic.Tests.Infrastructure.SpellChecker
{
    ...
    {
        private CoretorOrtografic.Core.RadixTree.RadixTree _rt;
        private RT_Checker _checker;

        [SetUp]
        public void Setup()
        {
            _rt = new CoretorOrtografic.Core.RadixTree.RadixTree(DictionaryFilePaths.WORDS_RADIX_TREE_FILE_PATH);
